...
export const translations = {
  en: {
    ...
    proj5_desc: "A small C++ sandbox experiment built to learn C++ at a deeper level and understand rigid-body physics mechanics, quaternion dynamics, and RK4 integration from first principles.",
    proj5_b1: "Built as a personal coding sandbox to master modern C++ memory management, linear algebra, and numerical integration algorithms.",
    proj5_b2: "Implemented quaternion attitude math preventing gimbal lock during 3D rigid body flight state updates.",
    proj5_b3: "Programmed a 4th-Order Runge-Kutta (RK4) numerical integrator step running at a fixed 1,000 Hz loop frequency.",

    // C++ Physics Engine Subpage Specific EN Translations
    pe_hero_tag1: "Personal C++ Learning Project",
    pe_hero_tag2: "C++20 & Eigen Matrix",
    pe_hero_tag3: "RK4 Integrator",
    pe_hero_tag4: "Open Source Sandbox",
    pe_title: "AeroPhysicsEngine: C++ Physics Experiment",
    pe_desc: "A small C++ sandbox experiment built to learn C++ at a deeper level and understand rigid-body physics mechanics, quaternion dynamics, and RK4 integration from first principles.",
    pe_stat1_title: "Integration Step",
    pe_stat1_val: "1,000 Hz Fixed",
    pe_stat2_title: "Numerical Method",
    pe_stat2_val: "Runge-Kutta 4 (RK4)",
    pe_stat3_title: "Primary Purpose",
    pe_stat3_val: "C++ Mastery & Math",
    ...
    pe_intent_desc2: "By programming 6DoF rigid body kinematics, quaternion rotation math, and 4th-Order Runge-Kutta (RK4) integration from scratch, I gained a strong intuitive grasp of vector calculus and software architecture that directly benefited my work on complex robotics, embedded microcontrollers, and autonomous systems.",
    pe_diag_lbl: "// 6DoF KINEMATICS & VECTOR SCHEMATIC",
    pe_sec1_title: "1. Rigid Body Kinematics & Quaternion Math",
    pe_sec1_desc: "To prevent gimbal lock issues inherent to Euler angle representations during 3D rotations, orientation is calculated using quaternions (q = [w, x, y, z]). Linear and angular velocities are tracked in body-fixed frame coordinates, allowing clean transformation of forces and torques.",
    pe_sec2_title: "2. 4th-Order Runge-Kutta (RK4) Integrator Implementation",
    pe_sec2_desc: "Euler integration often suffers from numerical accumulation errors. I implemented a 4th-Order Runge-Kutta (RK4) integrator step to evaluate state derivatives at 4 intermediate time steps per tick, maintaining stability during fixed 1,000 Hz loop updates:",
  ...
  de: {
    ...
    proj5_desc: "Ein einfaches C++ Experiment, entwickelt um C++ auf einer tieferen Ebene zu lernen und die Funktionsweise von Starrkörper-Physik-Engines, Quaternionen-Dynamik und RK4-Integration von Grund auf zu verstehen.",
    proj5_b1: "Entwickelt als persönliches Programmier-Sandbox-Projekt zur Vertiefung von C++ Speicherverwaltung, linearer Algebra und numerischen Integrationsverfahren.",
    proj5_b2: "Implementierung von Quaternionen-Lageregelung zur Vermeidung von Gimbal-Lock bei 3D-Starrkörper-Bewegungen.",
    proj5_b3: "Programmierung eines Runge-Kutta Integrators 4. Ordnung (RK4) bei festem 1.000 Hz Simulationsschritt.",
    ...
    pe_desc: "Ein einfaches C++ Experiment, entwickelt um C++ auf einer tieferen Ebene zu lernen und die Funktionsweise von Starrkörper-Physik-Engines, Quaternionen-Dynamik und RK4-Integration von Grund auf zu verstehen.",
    pe_stat1_title: "Integrationsschritt",
    pe_stat1_val: "1.000 Hz Fest",
    pe_stat2_title: "Numerisches Verfahren",
    pe_stat2_val: "Runge-Kutta 4 (RK4)",
    pe_stat3_title: "Hauptziel",
    pe_stat3_val: "C++ Praxis & Mathe",
    pe_stat4_title: "Repository",
    pe_stat4_val: "GitHub Open Source",
    ...
    pe_intent_desc2: "Durch das eigenständige Programmieren von 6DoF Starrkörper-Kinematik, Quaternionen-Drehungen und RK4-Integration habe ich ein fundiertes Verständnis für Vektorrechnung und Software-Architektur entwickelt, das meinen Arbeiten an komplexer Robotik, Embedded Mikrocontrollern und autonomen Systemen direkt zugute kam.",
    pe_diag_lbl: "// 6DoF KINEMATIK & VEKTOR-SCHALTPLAN",
    pe_sec1_title: "1. Starrkörper-Kinematik & Quaternionen-Mathematik",
    pe_sec1_desc: "Um Gimbal-Lock-Probleme von Euler-Winkeln bei 3D-Rotationen zu vermeiden, wird die Orientierung mit Quaternionen (q = [w, x, y, z]) berechnet. Translation und Winkelgeschwindigkeiten werden im fahrzeugfesten Koordinatensystem verarbeitet.",
    pe_sec2_title: "2. Runge-Kutta Integrator 4. Ordnung (RK4) Implementierung",
    pe_sec2_desc: "Einfache Euler-Integration leidet oft unter numerischen Summenfehlern. Ich habe einen RK4-Integrationsschritt implementiert, der Zustandskennwerte an 4 Zwischenzeitpunkten pro Zeitschritt auswertet und so hohe Stabilität bei 1.000 Hz Zeitschleifen garantiert:",
